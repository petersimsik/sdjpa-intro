...
CREATE DATABASE IF NOT EXISTS bookdb CHARACTER SET utf8mb4 COLLATE utf8mb4_slovak_ci;
CREATE USER IF NOT EXISTS `bookadmin`@`%` IDENTIFIED BY 'bookadminpwd';
CREATE USER IF NOT EXISTS `bookuser`@`%` IDENTIFIED BY 'bookuserpwd';
